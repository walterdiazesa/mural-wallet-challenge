...
const index = ({ className }: { className?: string }) => {
  useEffect(() => {
    if (document.getElementById("logo-container")!.childElementCount > 0)
      return;

    //#region no-console
    console.log(
      `%c==================\nFrom CriptoDodo we strongly suggest closing the developer tools ;)\n                         \nIt is really dododemanding for the metamask fox animation, you kill a dodo every time you open this tab :(\n==================\nNot a dodo:           
              __.------.
           .-' .---.    \\
         .'  .' O   )/"\\/
       .'    )     >:'  L
...
WD   | | |F
`,
      `color: white; font-weight: 900; background: rgb(193,101,221);
background: -moz-linear-gradient(90deg, rgba(193,101,221,1) 0%, rgba(193,101,221,1) 36%, rgba(92,39,254,1) 100%);
background: -webkit-linear-gradient(90deg, rgba(193,101,221,1) 0%, rgba(193,101,221,1) 36%, rgba(92,39,254,1) 100%);
background: linear-gradient(90deg, rgba(193,101,221,1) 0%, rgba(193,101,221,1) 36%, rgba(92,39,254,1) 100%);
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#c165dd",endColorstr="#5c27fe",GradientType=1);`
    );
    //#endregion

    //#region (legacy-js) codepen metamask {https://codepen.io/shivammathur/pen/ZVJaEy}
    ...
    (function () {
      function e(
        t: { [x: string]: { [x: string]: any }[] },
        n: { [x: string]: { exports: any } },
        r: string | any[]
      ) {
        function s(o: string, u: undefined) {
          if (!n[o]) {
            if (!t[o]) {
      ...
      {
        1: [
          function (a: (arg0: string) => any, b: any, c: any) {
            var d = a("../index"),
              viewer = d({
                width: 0.4,
                height: 0.4,
        ...
        2: [
          function (
            ...
            b: {
              exports: {
                positions: number[][];
                chunks: { color: number[]; faces: number[][] }[];
              };
            },
            c: any
          ) {
          ...
          function (
            ...
            q: {
              exports: (t: any) => {
                container: Element;
                lookAt: (t: any) => void;
                setFollowMouse: (t: any) => void;
                setFollowMotion: (t: any) => void;
                stopAnimation: () => void;
                startAnimation: () => void;
              };
            },
            ...
            function createNode(t: string) {
              return document.createElementNS(SVG_NS, t);
            }
            function setAttribute(t: Element, e: string, n: string) {
            ...
            q.exports = function (t: {}) {
              ...
              function i(t: { zIndex: number }, e: { zIndex: number }) {
              ...
              deviceOrientationListener = function (t: any) {
                if ((v || l(), d)) {
                  const n = event.gamma,
                    r = event.beta;
                  e({
        ...
        4: [
          function (a: (arg0: string) => any, b: { exports: any }, c: any) {
            "use strict";
        ...
        5: [
          function (a: any, b: { exports: (t: any) => any }, c: any) {
        ...
        6: [
          function (F: any, G: { exports: (n: any, r: any) => any }, H: any) {
            function invert(n: number[], r: any[]) {
              var e = r[0],
                t = r[1],
                u = r[2],
                i = r[3],
        ...
        7: [
          function (
            g: (arg0: string) => any,
            j: { exports: (t: any, a: any, e: any, r: any) => any },
            w: any
          ) {
            function lookAt(t: number[], a: any[], e: any[], r: any[]) {
              var i,
                o,
                s,
                h,
        ...
        8: [
          function (
            q: any,
            w: { exports: (l: any, t: any, u: any) => any },
            z: any
          ) {
            function multiply(l: number[], t: any[], u: any[]) {
              var r = t[0],
                e = t[1],
                i = t[2],
                m = t[3],
        ...
        9: [
          function (
            b: any,
            d: { exports: (e: any, t: any, r: any, p: any, n: any) => any },
            f: any
          ) {
        ...
        10: [
          function (
            F: any,
            G: { exports: (t: any, a: any, r: any, e: any) => any },
            H: any
          ) {
            function rotate(t: any[], a: any[], r: number, e: any[]) {
              var o,
                n,
                s,
                h,
        ...
        11: [
          function (
            b: any,
            c: { exports: (r: any, t: any, a: any) => any },
            d: any
          ) {
            function transformMat4(r: number[], t: any[], a: number[]) {
              var n = t[0],
                o = t[1],
                e = t[2],
        ...
        12: [
          function (b: any, c: { exports: () => () => void }, d: any) {
            c.exports = function () {
              var e = document.getSelection();
              if (!e.rangeCount) return function () {};
              for (
                var n = document.activeElement, t: Range[] = [], a = 0;
                a < e.rangeCount;
                a++
              )
  ...
  return (
    <div id="logo-container" className={`${className} transform-gpu`}></div>
  );
};
